        ...
        <div className="container-fluid">
            <div className="row">
                <div className="col-lg-4">
                    <img src={found.image} alt="" width="100%"/>
                </div>
                <div className="col-lg-8">
                    <h5>Alesuada fames ac turpis</h5>
                    <hr />
                    <h6>{found.Price}</h6>
                    <p>{found.details}</p>
                    <div className="row">
                    <div className="col-lg-2 bg-light">DESCRIPTION</div>
                    <div className="col-lg-2">REVIEWS(0)</div>
                    <div className="col-lg-3">META INFORMATION</div>
                    <p className='bg-light'>{found.details1}</p>
